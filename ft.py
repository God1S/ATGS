...
def _TEAM_RANDOM_M1(ids):
    ...
    try:
        for pw in plist:
            ...
            '__a': '1',
            '__req': '7',
            '__hs': '20474.BP:DEFAULT.2.0...0',
            'dpr': '3',
            '__ccg': 'EXCELLENT',
            '__rev': str(random.randint(1000000000,1999999999)),
            '__s': 'wupgtf:yvh85n:ncic61',
            '__hsi': str(int(time.time() * 10000000)),
            '__dyn': '7xe6E5aQ1PyUbFp41twpUnwgU29zE6u7E3rw5ux609vCwjE1EE2Cw8G1Qw5Mx61vw5zwqo1nE1u83mwaS0zK1sw2oEG0xo2ewbS1Lw7Jw5lw8S0QU3yw',
            'fb_dtsg': 'NAfvC0aU8y4SDrGrp1Mt1XggXkVnOKRpuhG7_Hv4wdCA9Y86mBbqX6A:0:0',
